...
export default function OrganicShape({ mousePosition }) {
    ...
    return new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          float mouseInfluence = distance(uv, uMouse) * 0.5;
          vec3 newPosition = position + normal * noise * 0.3 * (1.0 - mouseInfluence);
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          float mixStrength = (vNormal.z + 1.0) * 0.5;
          vec3 color = mix(uColor1, uColor2, mixStrength);
          color = mix(color, uColor3, sin(vUv.x * 10.0 + uTime) * 0.3 + 0.3);
          
          // Add fresnel effect
          vec3 viewDirection = normalize(cameraPosition - vPosition);
          float fresnel = pow(1.0 - dot(viewDirection, vNormal), 3.0);
          color += vec3(0.2, 0.4, 0.6) * fresnel * 0.5;
